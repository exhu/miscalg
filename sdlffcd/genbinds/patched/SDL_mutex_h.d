 ...
 */
extern (D) auto SDL_CAPABILITY(T)(auto ref T x)
{
    return SDL_THREAD_ANNOTATION_ATTRIBUTE__(capability(x));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
enum SDL_SCOPED_CAPABILITY = SDL_THREAD_ANNOTATION_ATTRIBUTE__(scoped_lockable);
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_GUARDED_BY(T)(auto ref T x)
{
    return SDL_THREAD_ANNOTATION_ATTRIBUTE__(guarded_by(x));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_PT_GUARDED_BY(T)(auto ref T x)
{
    return SDL_THREAD_ANNOTATION_ATTRIBUTE__(pt_guarded_by(x));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_ACQUIRED_BEFORE(T)(auto ref T x)
{
    return SDL_THREAD_ANNOTATION_ATTRIBUTE__(acquired_before(x));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_ACQUIRED_AFTER(T)(auto ref T x)
{
    return SDL_THREAD_ANNOTATION_ATTRIBUTE__(acquired_after(x));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_REQUIRES(T)(auto ref T x)
{
    return SDL_THREAD_ANNOTATION_ATTRIBUTE__(requires_capability(x));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_REQUIRES_SHARED(T)(auto ref T x)
{
    return SDL_THREAD_ANNOTATION_ATTRIBUTE__(requires_shared_capability(x));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_ACQUIRE(T)(auto ref T x)
{
    return SDL_THREAD_ANNOTATION_ATTRIBUTE__(acquire_capability(x));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_ACQUIRE_SHARED(T)(auto ref T x)
{
    return SDL_THREAD_ANNOTATION_ATTRIBUTE__(acquire_shared_capability(x));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_RELEASE(T)(auto ref T x)
{
    return SDL_THREAD_ANNOTATION_ATTRIBUTE__(release_capability(x));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_RELEASE_SHARED(T)(auto ref T x)
{
    return SDL_THREAD_ANNOTATION_ATTRIBUTE__(release_shared_capability(x));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_RELEASE_GENERIC(T)(auto ref T x)
{
    return SDL_THREAD_ANNOTATION_ATTRIBUTE__(release_generic_capability(x));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_TRY_ACQUIRE(T0, T1)(auto ref T0 x, auto ref T1 y)
{
    return SDL_THREAD_ANNOTATION_ATTRIBUTE__(try_acquire_capability(x, y));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_TRY_ACQUIRE_SHARED(T0, T1)(auto ref T0 x, auto ref T1 y)
{
    return SDL_THREAD_ANNOTATION_ATTRIBUTE__(try_acquire_shared_capability(x, y));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_EXCLUDES(T)(auto ref T x)
{
    return SDL_THREAD_ANNOTATION_ATTRIBUTE__(locks_excluded(x));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_ASSERT_CAPABILITY(T)(auto ref T x)
{
    return SDL_THREAD_ANNOTATION_ATTRIBUTE__(assert_capability(x));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_ASSERT_SHARED_CAPABILITY(T)(auto ref T x)
{
    return SDL_THREAD_ANNOTATION_ATTRIBUTE__(assert_shared_capability(x));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_RETURN_CAPABILITY(T)(auto ref T x)
{
    return SDL_THREAD_ANNOTATION_ATTRIBUTE__(lock_returned(x));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
enum SDL_NO_THREAD_SAFETY_ANALYSIS = SDL_THREAD_ANNOTATION_ATTRIBUTE__(no_thread_safety_analysis);
