...
{
    SDL_SYSTEM_THEME_UNKNOWN = 0, /**< Unknown system theme */
    SDL_SYSTEM_THEME_LIGHT = 1, /**< Light colored system theme */
    SDL_SYSTEM_THEME_DARK = 2 /**< Dark colored system theme */
}
 ...
 */
alias SDL_WindowFlags = c_ulong;

enum SDL_WINDOW_FULLSCREEN = SDL_UINT64_C(0x0000000000000001); /**< window is in fullscreen mode */
enum SDL_WINDOW_OPENGL = SDL_UINT64_C(0x0000000000000002); /**< window usable with OpenGL context */
enum SDL_WINDOW_OCCLUDED = SDL_UINT64_C(0x0000000000000004); /**< window is occluded */
enum SDL_WINDOW_HIDDEN = SDL_UINT64_C(0x0000000000000008); /**< window is neither mapped onto the desktop nor shown in the taskbar/dock/window list; SDL_ShowWindow() is required for it to become visible */
enum SDL_WINDOW_BORDERLESS = SDL_UINT64_C(0x0000000000000010); /**< no window decoration */
enum SDL_WINDOW_RESIZABLE = SDL_UINT64_C(0x0000000000000020); /**< window can be resized */
enum SDL_WINDOW_MINIMIZED = SDL_UINT64_C(0x0000000000000040); /**< window is minimized */
enum SDL_WINDOW_MAXIMIZED = SDL_UINT64_C(0x0000000000000080); /**< window is maximized */
enum SDL_WINDOW_MOUSE_GRABBED = SDL_UINT64_C(0x0000000000000100); /**< window has grabbed mouse input */
enum SDL_WINDOW_INPUT_FOCUS = SDL_UINT64_C(0x0000000000000200); /**< window has input focus */
enum SDL_WINDOW_MOUSE_FOCUS = SDL_UINT64_C(0x0000000000000400); /**< window has mouse focus */
enum SDL_WINDOW_EXTERNAL = SDL_UINT64_C(0x0000000000000800); /**< window not created by SDL */
enum SDL_WINDOW_MODAL = SDL_UINT64_C(0x0000000000001000); /**< window is modal */
enum SDL_WINDOW_HIGH_PIXEL_DENSITY = SDL_UINT64_C(0x0000000000002000); /**< window uses high pixel density back buffer if possible */
enum SDL_WINDOW_MOUSE_CAPTURE = SDL_UINT64_C(0x0000000000004000); /**< window has mouse captured (unrelated to MOUSE_GRABBED) */
enum SDL_WINDOW_MOUSE_RELATIVE_MODE = SDL_UINT64_C(0x0000000000008000); /**< window has relative mode enabled */
enum SDL_WINDOW_ALWAYS_ON_TOP = SDL_UINT64_C(0x0000000000010000); /**< window should always be above others */
enum SDL_WINDOW_UTILITY = SDL_UINT64_C(0x0000000000020000); /**< window should be treated as a utility window, not showing in the task bar and window list */
enum SDL_WINDOW_TOOLTIP = SDL_UINT64_C(0x0000000000040000); /**< window should be treated as a tooltip and does not get mouse or keyboard focus, requires a parent window */
enum SDL_WINDOW_POPUP_MENU = SDL_UINT64_C(0x0000000000080000); /**< window should be treated as a popup menu, requires a parent window */
enum SDL_WINDOW_KEYBOARD_GRABBED = SDL_UINT64_C(0x0000000000100000); /**< window has grabbed keyboard input */
enum SDL_WINDOW_FILL_DOCUMENT = SDL_UINT64_C(0x0000000000200000); /**< window is in fill-document mode (Emscripten only), since SDL 3.4.0 */
enum SDL_WINDOW_VULKAN = SDL_UINT64_C(0x0000000010000000); /**< window usable for Vulkan surface */
enum SDL_WINDOW_METAL = SDL_UINT64_C(0x0000000020000000); /**< window usable for Metal view */
enum SDL_WINDOW_TRANSPARENT = SDL_UINT64_C(0x0000000040000000); /**< window with transparent buffer */
enum SDL_WINDOW_NOT_FOCUSABLE = SDL_UINT64_C(0x0000000080000000); /**< window should not be focusable */
...
enum SDL_FlashOperation
{
    ...
    SDL_FLASH_BRIEFLY = 1, /**< Flash the window briefly to get attention */
    SDL_FLASH_UNTIL_FOCUSED = 2 /**< Flash the window until it gets focus */
}
...
enum SDL_ProgressState
{
    ...
    SDL_PROGRESS_STATE_NONE = 0, /**< No progress bar is shown */
    SDL_PROGRESS_STATE_INDETERMINATE = 1, /**< The progress bar is shown in a indeterminate state */
    SDL_PROGRESS_STATE_NORMAL = 2, /**< The progress bar is shown in a normal state */
    SDL_PROGRESS_STATE_PAUSED = 3, /**< The progress bar is shown in a paused state */
    SDL_PROGRESS_STATE_ERROR = 4 /**< The progress bar is shown in a state indicating the application had an error */
}
 ...
 */
alias SDL_EGLAttribArrayCallback = c_long* function (void* userdata);
 ...
 * \sa SDL_EGL_SetAttributeCallbacks
 */
alias SDL_EGLIntArrayCallback = int* function (void* userdata, SDL_EGLDisplay display, SDL_EGLConfig config);
 ...
 * \since This datatype is available since SDL 3.2.0.
 */
alias SDL_GLProfile = uint;

enum SDL_GL_CONTEXT_PROFILE_CORE = 0x0001; /**< OpenGL Core Profile context */
enum SDL_GL_CONTEXT_PROFILE_COMPATIBILITY = 0x0002; /**< OpenGL Compatibility Profile context */
enum SDL_GL_CONTEXT_PROFILE_ES = 0x0004; /**< GLX_CONTEXT_ES2_PROFILE_BIT_EXT */
 ...
 * \since This datatype is available since SDL 3.2.0.
 */
alias SDL_GLContextFlag = uint;

enum SDL_GL_CONTEXT_DEBUG_FLAG = 0x0001;
enum SDL_GL_CONTEXT_FORWARD_COMPATIBLE_FLAG = 0x0002;
enum SDL_GL_CONTEXT_ROBUST_ACCESS_FLAG = 0x0004;
enum SDL_GL_CONTEXT_RESET_ISOLATION_FLAG = 0x0008;
 ...
 * \since This datatype is available since SDL 3.2.0.
 */
alias SDL_GLContextReleaseFlag = uint;

enum SDL_GL_CONTEXT_RELEASE_BEHAVIOR_NONE = 0x0000;
enum SDL_GL_CONTEXT_RELEASE_BEHAVIOR_FLUSH = 0x0001;
 ...
 * \since This datatype is available since SDL 3.2.0.
 */
alias SDL_GLContextResetNotification = uint;

enum SDL_GL_CONTEXT_RESET_NO_NOTIFICATION = 0x0000;
enum SDL_GL_CONTEXT_RESET_LOSE_CONTEXT = 0x0001;
...
enum SDL_PROP_DISPLAY_WAYLAND_WL_OUTPUT_POINTER = "SDL.display.wayland.wl_output";
enum SDL_PROP_DISPLAY_WINDOWS_HMONITOR_POINTER = "SDL.display.windows.hmonitor";
...
enum SDL_PROP_WINDOW_CREATE_CONSTRAIN_POPUP_BOOLEAN = "SDL.window.create.constrain_popup";
...
enum SDL_PROP_WINDOW_CREATE_WINDOWSCENE_POINTER = "SDL.window.create.uikit.windowscene";
...
enum SDL_PROP_WINDOW_CREATE_EMSCRIPTEN_CANVAS_ID_STRING = "SDL.window.create.emscripten.canvas_id";
enum SDL_PROP_WINDOW_CREATE_EMSCRIPTEN_KEYBOARD_ELEMENT_STRING = "SDL.window.create.emscripten.keyboard_element";
...
enum SDL_PROP_WINDOW_OPENVR_OVERLAY_ID_NUMBER = "SDL.window.openvr.overlay_id";
...
enum SDL_PROP_WINDOW_EMSCRIPTEN_CANVAS_ID_STRING = "SDL.window.emscripten.canvas_id";
enum SDL_PROP_WINDOW_EMSCRIPTEN_KEYBOARD_ELEMENT_STRING = "SDL.window.emscripten.keyboard_element";
...
enum SDL_HitTestResult
{
    ...
    SDL_HITTEST_RESIZE_TOPLEFT = 2, /**< Region is the resizable top-left corner border. */
    SDL_HITTEST_RESIZE_TOP = 3, /**< Region is the resizable top border. */
    SDL_HITTEST_RESIZE_TOPRIGHT = 4, /**< Region is the resizable top-right corner border. */
    SDL_HITTEST_RESIZE_RIGHT = 5, /**< Region is the resizable right border. */
    SDL_HITTEST_RESIZE_BOTTOMRIGHT = 6, /**< Region is the resizable bottom-right corner border. */
    SDL_HITTEST_RESIZE_BOTTOM = 7, /**< Region is the resizable bottom border. */
    SDL_HITTEST_RESIZE_BOTTOMLEFT = 8, /**< Region is the resizable bottom-left corner border. */
