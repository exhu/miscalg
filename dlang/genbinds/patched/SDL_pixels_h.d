 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_PIXELFLAG(T)(auto ref T format)
{
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_PIXELTYPE(T)(auto ref T format)
{
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_PIXELORDER(T)(auto ref T format)
{
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_PIXELLAYOUT(T)(auto ref T format)
{
 ...
 */
extern (D) auto SDL_BITSPERPIXEL(T)(auto ref T format)
{
 ...
 * \sa SDL_BITSPERPIXEL
 */
extern (D) auto SDL_BYTESPERPIXEL(T)(auto ref T format)
{
    return SDL_ISPIXELFORMAT_FOURCC(format) ? (((format == SDL_PixelFormat.SDL_PIXELFORMAT_YUY2) || (format == SDL_PixelFormat.SDL_PIXELFORMAT_UYVY) || (format == SDL_PixelFormat.SDL_PIXELFORMAT_YVYU) || (format == SDL_PixelFormat.SDL_PIXELFORMAT_P010)) ? 2 : 1) : ((format >> 0) & 0xFF);
}
...
{
    return !SDL_ISPIXELFORMAT_FOURCC(format) && ((SDL_PIXELTYPE(format) == SDL_PixelType.SDL_PIXELTYPE_INDEX1) || (SDL_PIXELTYPE(format) == SDL_PixelType.SDL_PIXELTYPE_INDEX2) || (SDL_PIXELTYPE(format) == SDL_PixelType.SDL_PIXELTYPE_INDEX4) || (SDL_PIXELTYPE(format) == SDL_PixelType.SDL_PIXELTYPE_INDEX8));
}
...
{
    return !SDL_ISPIXELFORMAT_FOURCC(format) && ((SDL_PIXELTYPE(format) == SDL_PixelType.SDL_PIXELTYPE_PACKED8) || (SDL_PIXELTYPE(format) == SDL_PixelType.SDL_PIXELTYPE_PACKED16) || (SDL_PIXELTYPE(format) == SDL_PixelType.SDL_PIXELTYPE_PACKED32));
}
...
{
    return !SDL_ISPIXELFORMAT_FOURCC(format) && ((SDL_PIXELTYPE(format) == SDL_PixelType.SDL_PIXELTYPE_ARRAYU8) || (SDL_PIXELTYPE(format) == SDL_PixelType.SDL_PIXELTYPE_ARRAYU16) || (SDL_PIXELTYPE(format) == SDL_PixelType.SDL_PIXELTYPE_ARRAYU32) || (SDL_PIXELTYPE(format) == SDL_PixelType.SDL_PIXELTYPE_ARRAYF16) || (SDL_PIXELTYPE(format) == SDL_PixelType.SDL_PIXELTYPE_ARRAYF32));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_ISPIXELFORMAT_10BIT(T)(auto ref T format)
{
    return !SDL_ISPIXELFORMAT_FOURCC(format) && ((SDL_PIXELTYPE(format) == SDL_PixelType.SDL_PIXELTYPE_PACKED32) && (SDL_PIXELLAYOUT(format) == SDL_PackedLayout.SDL_PACKEDLAYOUT_2101010));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_ISPIXELFORMAT_FLOAT(T)(auto ref T format)
{
    return !SDL_ISPIXELFORMAT_FOURCC(format) && ((SDL_PIXELTYPE(format) == SDL_PixelType.SDL_PIXELTYPE_ARRAYF16) || (SDL_PIXELTYPE(format) == SDL_PixelType.SDL_PIXELTYPE_ARRAYF32));
}
...
{
    return (SDL_ISPIXELFORMAT_PACKED(format) && ((SDL_PIXELORDER(format) == SDL_PackedOrder.SDL_PACKEDORDER_ARGB) || (SDL_PIXELORDER(format) == SDL_PackedOrder.SDL_PACKEDORDER_RGBA) || (SDL_PIXELORDER(format) == SDL_PackedOrder.SDL_PACKEDORDER_ABGR) || (SDL_PIXELORDER(format) == SDL_PackedOrder.SDL_PACKEDORDER_BGRA))) || (SDL_ISPIXELFORMAT_ARRAY(format) && ((SDL_PIXELORDER(format) == SDL_ArrayOrder.SDL_ARRAYORDER_ARGB) || (SDL_PIXELORDER(format) == SDL_ArrayOrder.SDL_ARRAYORDER_RGBA) || (SDL_PIXELORDER(format) == SDL_ArrayOrder.SDL_ARRAYORDER_ABGR) || (SDL_PIXELORDER(format) == SDL_ArrayOrder.SDL_ARRAYORDER_BGRA)));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_DEFINE_COLORSPACE(T0, T1, T2, T3, T4, T5)(auto ref T0 type, auto ref T1 range, auto ref T2 primaries, auto ref T3 transfer, auto ref T4 matrix, auto ref T5 chroma)
{
    return (cast(Uint32) type << 28) | (cast(Uint32) range << 24) | (cast(Uint32) chroma << 20) | (cast(Uint32) primaries << 10) | (cast(Uint32) transfer << 5) | (cast(Uint32) matrix << 0);
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_COLORSPACETYPE(T)(auto ref T cspace)
{
    return cast(SDL_ColorType) (cspace >> 28) & 0x0F;
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_COLORSPACERANGE(T)(auto ref T cspace)
{
    return cast(SDL_ColorRange) (cspace >> 24) & 0x0F;
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_COLORSPACECHROMA(T)(auto ref T cspace)
{
    return cast(SDL_ChromaLocation) (cspace >> 20) & 0x0F;
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_COLORSPACEPRIMARIES(T)(auto ref T cspace)
{
    return cast(SDL_ColorPrimaries) (cspace >> 10) & 0x1F;
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_COLORSPACETRANSFER(T)(auto ref T cspace)
{
    return cast(SDL_TransferCharacteristics) (cspace >> 5) & 0x1F;
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_COLORSPACEMATRIX(T)(auto ref T cspace)
{
    return cast(SDL_MatrixCoefficients) cspace & 0x1F;
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_ISCOLORSPACE_MATRIX_BT601(T)(auto ref T cspace)
{
    return SDL_COLORSPACEMATRIX(cspace) == SDL_MatrixCoefficients.SDL_MATRIX_COEFFICIENTS_BT601 || SDL_COLORSPACEMATRIX(cspace) == SDL_MatrixCoefficients.SDL_MATRIX_COEFFICIENTS_BT470BG;
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_ISCOLORSPACE_MATRIX_BT709(T)(auto ref T cspace)
{
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_ISCOLORSPACE_MATRIX_BT2020_NCL(T)(auto ref T cspace)
{
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_ISCOLORSPACE_LIMITED_RANGE(T)(auto ref T cspace)
{
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_ISCOLORSPACE_FULL_RANGE(T)(auto ref T cspace)
{
    return SDL_COLORSPACERANGE(cspace) == SDL_ColorRange.SDL_COLOR_RANGE_FULL;
}
