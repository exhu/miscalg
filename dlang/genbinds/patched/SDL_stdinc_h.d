...
/* long long introduced in Visual Studio.NET 2003 */
...
extern (D) auto SDL_reinterpret_cast(type, T)(auto ref T expression)
{
...
alias SDL_SINT64_C = INT64_C;

/* !SDL_SINT64_C */

alias SDL_UINT64_C = UINT64_C;
 ...
 */
alias Sint8 = byte;
enum SDL_MAX_SINT8 = cast(Sint8) 0x7F; /* 127 */
enum SDL_MIN_SINT8 = cast(Sint8) ~0x7F; /* -128 */
 ...
 */
alias Uint8 = ubyte;
enum SDL_MAX_UINT8 = cast(Uint8) 0xFF; /* 255 */
enum SDL_MIN_UINT8 = cast(Uint8) 0x00; /* 0 */
 ...
 */
alias Sint16 = short;
enum SDL_MAX_SINT16 = cast(Sint16) 0x7FFF; /* 32767 */
enum SDL_MIN_SINT16 = cast(Sint16) ~0x7FFF; /* -32768 */
 ...
 */
alias Uint16 = ushort;
enum SDL_MAX_UINT16 = cast(Uint16) 0xFFFF; /* 65535 */
enum SDL_MIN_UINT16 = cast(Uint16) 0x0000; /* 0 */
 ...
 */
alias Sint32 = int;
enum SDL_MAX_SINT32 = cast(Sint32) 0x7FFFFFFF; /* 2147483647 */
enum SDL_MIN_SINT32 = cast(Sint32) ~0x7FFFFFFF; /* -2147483648 */
 ...
 */
alias Uint32 = uint;
enum SDL_MAX_UINT32 = cast(Uint32) 0xFFFFFFFFu; /* 4294967295 */
enum SDL_MIN_UINT32 = cast(Uint32) 0x00000000; /* 0 */
 ...
 */
alias Sint64 = c_long;
enum SDL_MAX_SINT64 = SDL_SINT64_C(0x7FFFFFFFFFFFFFFF); /* 9223372036854775807 */
enum SDL_MIN_SINT64 = ~SDL_SINT64_C(0x7FFFFFFFFFFFFFFF); /* -9223372036854775808 */
...
enum SDL_MAX_UINT64 = SDL_UINT64_C(0xFFFFFFFFFFFFFFFF); /* 18446744073709551615 */
enum SDL_MIN_UINT64 = SDL_UINT64_C(0x0000000000000000); /* 0 */
 ...
 * \sa SDL_MIN_SINT64
 */
alias SDL_Time = c_long;
enum SDL_MAX_TIME = SDL_MAX_SINT64;
enum SDL_MIN_TIME = SDL_MIN_SINT64;
 ...
 * \since This macro is available since SDL 3.2.0.
 */
enum SDL_FLT_EPSILON = 1.1920928955078125e-07F; /* 0x0.000002p0 */
...
enum SDL_PRIs32 = PRId32;

enum SDL_PRIu32 = PRIu32;

enum SDL_PRIx32 = PRIx32;
...
/* VS 2010 and above */ /* __attribute__ (( format( __wprintf__, fmtargnumber, fmtargnumber+1 ))) */ /* __attribute__ (( format( __wprintf__, fmtargnumber, 0 ))) */
...
extern (D) auto SDL_stack_free(T)(auto ref T data)
{
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_clamp(T0, T1, T2)(auto ref T0 x, auto ref T1 a, auto ref T2 b)
{
 ...
 * \sa SDL_zerop
 */
extern (D) auto SDL_zeroa(T)(auto ref T x)
{
    return SDL_memset();
}
 ...
 * \sa SDL_strtol
 */
c_long SDL_wcstol (const(wchar_t)* str, wchar_t** endp, int base);
 ...
 * \sa SDL_ltoa
 */
char* SDL_lltoa (long value, char* str, int radix);
 ...
 * \sa SDL_ultoa
 */
char* SDL_ulltoa (ulong value, char* str, int radix);
 ...
 * \sa SDL_lltoa
 */
long SDL_strtoll (const(char)* str, char** endp, int base);
 ...
 * \sa SDL_ulltoa
 */
ulong SDL_strtoull (const(char)* str, char** endp, int base);
 ...
 * \sa SDL_StepUTF8
 */
enum SDL_INVALID_UNICODE_CODEPOINT = 0xFFFD;
 ...
 * \sa SDL_PI_F
 */
enum SDL_PI_D = 3.141592653589793238462643383279502884; /**< pi (double) */
 ...
 * \sa SDL_PI_D
 */
enum SDL_PI_F = 3.141592653589793238462643383279502884F; /**< pi (float) */
...
enum SDL_ICONV_ERROR = cast(size_t) -1; /**< Generic error. Check SDL_GetError()? */
enum SDL_ICONV_E2BIG = cast(size_t) -2; /**< Output buffer was too small. */
enum SDL_ICONV_EILSEQ = cast(size_t) -3; /**< Invalid input sequence was encountered. */
enum SDL_ICONV_EINVAL = cast(size_t) -4; /**< Incomplete input sequence was encountered. */
...
{
    return SDL_reinterpret_cast!Uint16*(SDL_iconv_string("UCS-2", "UTF-8", S, SDL_strlen(S) + 1));
}
...
{
    return SDL_reinterpret_cast!Uint32*(SDL_iconv_string("UCS-4", "UTF-8", S, SDL_strlen(S) + 1));
}
 ...
 * \since This macro is available since SDL 3.2.0.
 */
extern (D) auto SDL_iconv_wchar_utf8(T)(auto ref T S)
{
    return SDL_iconv_string("UTF-8", "WCHAR_T", SDL_reinterpret_cast!const(char)*(S), (SDL_wcslen(S) + 1) * wchar_t.sizeof);
}
...
bool SDL_size_mul_check_overflow_builtin (size_t a, size_t b, size_t* ret);
alias SDL_size_mul_check_overflow = SDL_size_mul_check_overflow_builtin;
...
bool SDL_size_add_check_overflow_builtin (size_t a, size_t b, size_t* ret);
alias SDL_size_add_check_overflow = SDL_size_add_check_overflow_builtin;
